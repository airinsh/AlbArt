...
<head>
    ...
    <link rel="stylesheet" href="KlientiJepReview.css">
</head>
<body>
...
<div class="container my-5">
    <div class="card shadow-lg rounded-4 p-4">
        ...
        <div id="successMessage" class="text-center mt-4 d-none">
            ...
            <a href="../HomePage/Homepage.php" class="btn btn-outline-primary fw-semibold">
                Kthehu te Homepage
            </a>
        </div>
...
<script src="../Review/KlientiJepReview.js"></script>
</body>
</html>
