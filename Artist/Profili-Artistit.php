...
if (!$artist_id) {
    die("Ky user nuk eshte artist ose nuk ekziston.");
}
...
<main class="profile-page">
    ...
    <section class="profile-card">
        ...
        <div class="profile-body">
            ...
            <div class="profile-description-container">
                <p id="artist-description">Duke u ngarkuar pershkrimi...</p>
            ...
            <div class="profile-rating-container">
                ...
                <div class="add-product-btn">
                    <button onclick="window.location.href='../Produkt/ArtistiShtonProdukt.php'">
                        Shto Produkt
                    </button>
                </div>
            </div>
    ...
    <section class="profile-content">
        ...
        <div class="tab-content" id="reviews">
            <h3>Reviews</h3>
            <p class="placeholder">Nuk ka ende vleresime.</p>
        </div>
...
<div id="editDescModal" class="modal">
    <div class="modal-content">
        <h3>Edit Pershkrimin</h3>
        <textarea id="edit-desc-input" rows="5" placeholder="Shkruaj pershkrimin e artistit..."></textarea>
        <div class="modal-actions">
